...
public class AlertEquatorTest extends TestCase {
  ...
  protected void setUp() throws Exception {
    ...
    itemDescEquator = new AlertEquator(Arrays.asList("item", "longDescription"));
    allEquator = new AlertEquator(Arrays.asList("item", "longDescription"));
  }
  ...
  /**
   * Test method for {@link com.alertscape.pump.onramp.AlertEquator#hashAlert(com.alertscape.common.model.Alert)} .
   */
